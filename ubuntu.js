(function() {
	...
	var generate = function() {
		...
		if(nginx.checked) {
			...
			if(src.checked) appendSource(['echo "deb-src [signed-by=/etc/apt/keyrings/php.asc]', arch, 'http://nginx.org/packages/ubuntu/', rel, 'main'+ '" | sudo tee -a /etc/apt/sources.list.d/nginx.list > /dev/null']);
		}
